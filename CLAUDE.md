...
| `sbx` | 1.1.0 | Manage the Docker sandbox (`sbx` CLI) ola runs agents in: lifecycle, network policy, secrets, templates, resource limits (memory default + no-swap hard wall). Contract version-pinned; re-verify on sbx upgrade. |
